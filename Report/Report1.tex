...
The maximum number of infected people is 2823 and it is reached at the day 80. The pandemic ends at day 229 when the number of infected people is less than 1, at this day the number of susceptible people are 705 and the number of recovered one is 9294.
			...
			\includegraphics[width = 0.45\textwidth]{Lab6/SimulativeSIRModel(Rt)0.png} \\
	...
	\noindent
			...
			\subsection{S(t), I(t), R(t) plot}
			\includegraphics[width = 0.45\textwidth]{Lab6/SimulativeSIRModel(extension)0.png} \\
			
			\subsection{Rt(t) plot}
			 \includegraphics[width = 0.45\textwidth]{Lab6/SimulativeSIRModel(Rt)(extension)0.png} \\
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}SIR\\ Model\end{tabular}} &
  \textbf{\begin{tabular}[c]{@{}c@{}}Avg\\ Max\\ Infected\end{tabular}} &
  \textbf{\begin{tabular}[c]{@{}c@{}}RE\\ Max\\ Infected\end{tabular}} &
  \textbf{\begin{tabular}[c]{@{}c@{}}Avg\\ Max\\ Infected\\ (Day)\end{tabular}} &
  \textbf{\begin{tabular}[c]{@{}c@{}}RE\\ Max\\ Infected\\ Day\end{tabular}} &
  \textbf{\begin{tabular}[c]{@{}c@{}}Avg\\ End\\ Epidemic\end{tabular}} &
  \textbf{\begin{tabular}[c]{@{}c@{}}RE\\ End\\ Epidemic\end{tabular}} \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}Numerical\end{tabular}}          		& 2823 & / & 80 & / & 229 & / \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}Simulative\end{tabular}}               				& 2758.14 & 0.03 & 76 & 0.12 & 265 & 0.16 \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}Simulative\\ (extension)\end{tabular}} & 3204.16 & 0.03 & 66.5 & 0.11 & 211.5 & 0.06 \\ \hline
\end{tabular}%
}
\end{table}
